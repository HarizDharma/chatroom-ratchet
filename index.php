...
<html>
<head>
	<title>Chat Puskesmas Pandanwangi</title>
	<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
	<script src="https://code.jquery.com/jquery-3.2.1.min.js"></script>
</head>
<body>
	<div class="container">
		<h2 class="text-center" style="margin-top: 5px; padding-top: 0;">Fitur Chat Puskesmas Pandanwangi</h2>
		<hr>
		<?php 
			if(isset($_POST['join'])) {
				session_start();
		...
		<div class="row join-room">
			<div class="col-md-6 offset-3">
				<form id="join-room-frm" role="form" method="post" action="" class="form-horizontal">
	                ...
	                <div class="form-group">
	                    <input type="submit" value="Masuk" class="btn btn-success btn-block" id="join" name="join">
	                </div>
			    </form>
			</div>
		</div>
